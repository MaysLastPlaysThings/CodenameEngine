...
class Paths
{
	...
	inline static public function getAssetsRoot():String
		return Sys.getCwd() + ModsFolder.currentModFolder != null ? '${ModsFolder.modsPath}${ModsFolder.currentModFolder}' : #if (sys && TEST_BUILD) './${Main.pathBack}assets/' #else './assets' #end;
