...
class ModsFolder {
	 ...
	 */
	public static var modsPath:String = #if desktop "./mods/" #else Sys.getCwd() + "mods" #end;
	/**
	 * Path to the `addons` folder.
	 */
	public static var addonsPath:String = #if desktop "./addons/" #else Sys.getCwd() + "addons" #end;
